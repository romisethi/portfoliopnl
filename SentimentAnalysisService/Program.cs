...
using Microsoft.Extensions.DependencyInjection; // <--- Added using directive
...
// Register the AuditLoggingClient extension method from Shared
builder.Services.AddAuditLoggingClient(builder.Configuration);
builder.Services.AddScoped<ISentimentAnalysisService, SentimentAnalysisService.Services.SentimentAnalysisService>();
